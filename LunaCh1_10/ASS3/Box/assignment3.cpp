...
class Ass3 : public D3DApp
{
public:
	Ass3(HINSTANCE hInstance);
	~Ass3();
...
void Ass3::UpdateScene(float dt)
{
...
void Ass3::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void Ass3::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void Ass3::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void Ass3::BuildGeometryBuffers()
{
	...
	Vertex vertices[] =
	{
		{ XMFLOAT3(0, 1, 0), (const float*)&XMFLOAT4(1.0f, 1.0f, 1.0f, 0.3f)},
		{ XMFLOAT3(-1.0f, -1.0f, 0), (const float*)&XMFLOAT4(1.0f, 1.0f, 1.0f, 0.3f) },
		{ XMFLOAT3(+1.0f, -1.0f, 0), (const float*)&XMFLOAT4(1.0f, 1.0f, 1.0f, 0.3f) },

		
		{ XMFLOAT3(1, 1, 0.3f), (const float*)&Colors::Red },
		{ XMFLOAT3(0.0f, -1.0f, 0.3f), (const float*)&Colors::Red },
		{ XMFLOAT3(+2.0f, -1.0f, 0.3f), (const float*)&Colors::Red }
	};

	vertexCount = sizeof(vertices) * sizeof(Vertex);
	D3D11_BUFFER_DESC vbd;
	vbd.Usage = D3D11_USAGE_IMMUTABLE;
	vbd.ByteWidth = vertexCount;
