...
public:
	...
	struct Vertex2
	{
		...
		XMFLOAT2 TexC;*/
		Vertex2() {}
		Vertex2(const XMFLOAT3& p, const XMFLOAT3& n, const XMFLOAT2& t0, const XMFLOAT2& t1, const XMFLOAT2& t2, const XMFLOAT2& t3, const XMFLOAT2& t4, const XMFLOAT2& t5)
			:Pos(p), Normal(n), Tex0(t0), Tex1(t1), Tex2(t2), Tex3(t3), Tex4(t4), Tex5(t5) {}
		XMFLOAT3 Pos;
		XMFLOAT3 Normal;
		XMFLOAT2 Tex0;
		XMFLOAT2 Tex1;
	...
	void CreateMultiTexBox(float width, float height, float depth, MeshData& meshData);
